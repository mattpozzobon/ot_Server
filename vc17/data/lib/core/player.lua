...
function Player.feed(self, food)
	...
	if condition then
		...
		foodCondition:setParameter(CONDITION_PARAM_ENERGYGAIN, vocation:getEnergyGainAmount())
		foodCondition:setParameter(CONDITION_PARAM_ENERGYTICKS, vocation:getEnergyGainTicks() * 1000)
