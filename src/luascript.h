...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaPlayerSendAnimatedText(lua_State* L);
		...
		static int luaPlayerAddEnergy(lua_State* L);
		static int luaPlayerGetMaxMana(lua_State* L);
		static int luaPlayerGetMaxEnergy(lua_State* L);
		static int luaPlayerSetMaxMana(lua_State* L);
		static int luaPlayerGetEnergy(lua_State* L);
		static int luaPlayerSetMaxEnergy(lua_State* L);
		...
		static int luaPlayerGetBaseMaxEnergy(lua_State* L);
		...
		static int luaVocationGetEnergyGainTicks(lua_State* L);

		static int luaVocationGetEnergyGainAmount(lua_State* L);
