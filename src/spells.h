...
class Spell : public BaseSpell
{
	public:
		...
		TextColor_t getColour() const {
			if (colour == "") {return TEXTCOLOR_YELLOW;}
			else if (colour == "TEXTCOLOR_BLACK") {return TEXTCOLOR_BLACK;}
			else if (colour == "TEXTCOLOR_BLUE") { return TEXTCOLOR_BLUE; }
			else if (colour == "TEXTCOLOR_GREEN") { return TEXTCOLOR_GREEN; }
			else if (colour == "TEXTCOLOR_LIGHTGREEN") { return TEXTCOLOR_LIGHTGREEN; }
			else if (colour == "TEXTCOLOR_DARKBROWN") { return TEXTCOLOR_DARKBROWN; }
			else if (colour == "TEXTCOLOR_LIGHTBLUE") { return TEXTCOLOR_LIGHTBLUE; }
			else if (colour == "TEXTCOLOR_MAYABLUE") { return TEXTCOLOR_MAYABLUE; }
			else if (colour == "TEXTCOLOR_DARKRED") { return TEXTCOLOR_DARKRED; }
			else if (colour == "TEXTCOLOR_DARKPURPLE") { return TEXTCOLOR_DARKPURPLE; }
			else if (colour == "TEXTCOLOR_BROWN") { return TEXTCOLOR_BROWN; }
			else if (colour == "TEXTCOLOR_GREY") { return TEXTCOLOR_GREY; }
			else if (colour == "TEXTCOLOR_TEAL") { return TEXTCOLOR_TEAL; }
			else if (colour == "TEXTCOLOR_DARKPINK") { return TEXTCOLOR_DARKPINK; }
			else if (colour == "TEXTCOLOR_PURPLE") { return TEXTCOLOR_PURPLE; }
			else if (colour == "TEXTCOLOR_DARKORANGE") { return TEXTCOLOR_DARKORANGE; }
			else if (colour == "TEXTCOLOR_RED") { return TEXTCOLOR_RED; }
			else if (colour == "TEXTCOLOR_PINK") { return TEXTCOLOR_PINK; }
			else if (colour == "TEXTCOLOR_ORANGE") { return TEXTCOLOR_ORANGE; }
			else if (colour == "TEXTCOLOR_DARKYELLOW") { return TEXTCOLOR_DARKYELLOW; }
			else if (colour == "TEXTCOLOR_YELLOW") { return TEXTCOLOR_YELLOW; }
			else if (colour == "TEXTCOLOR_WHITE") { return TEXTCOLOR_WHITE; }
			else if (colour == "TEXTCOLOR_NONE") { return TEXTCOLOR_NONE; }
			else return TEXTCOLOR_BLACK;
		}
		...
		static void postCastSpell(Player* player, uint32_t manaCost, uint32_t energyCost, uint32_t soulCost);

		uint32_t getManaCost(const Player* player) const;
		uint32_t getEnergyCost() const;
